...
@RestController
@RequestMapping("/api/vgi-il-oauth-security-kafka")
public class VgiIlOauthSecurityKafkaResource {

    private final Logger log = LoggerFactory.getLogger(VgiIlOauthSecurityKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public VgiIlOauthSecurityKafkaResource(KafkaProperties kafkaProperties) {
