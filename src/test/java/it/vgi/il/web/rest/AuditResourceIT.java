package it.vgi.il.web.rest;

import it.vgi.il.VgiIlOauthSecurityApp;
import it.vgi.il.config.TestSecurityConfiguration;
import io.github.jhipster.config.JHipsterProperties;
import it.vgi.il.config.audit.AuditEventConverter;
import it.vgi.il.domain.PersistentAuditEvent;
import it.vgi.il.repository.PersistenceAuditEventRepository;
import it.vgi.il.security.AuthoritiesConstants;

import it.vgi.il.service.AuditEventService;
...
@SpringBootTest(classes = {VgiIlOauthSecurityApp.class, TestSecurityConfiguration.class})
@Transactional
